...
echo [3/5] Compilando y ejecutando pruebas...
dotnet test TechStore.sln || goto :failed
echo [4/5] Verificando configuracion SQL Server LAUTI / TechStoreDB...
findstr /C:"Server=LAUTI;Database=TechStoreDB" "TechStore.App\appsettings.json" >nul || goto :wrong_connection
echo [5/5] Iniciando TechStore.App conectado a SQL Server...
