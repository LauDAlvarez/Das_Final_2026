...
public class TechStoreDbContext : DbContext
{
 ...
 protected override void OnConfiguring(DbContextOptionsBuilder b){if(!b.IsConfigured)b.UseSqlServer(DatabaseOptions.ConnectionString,x=>x.EnableRetryOnFailure()).LogTo(message=>System.Diagnostics.Debug.WriteLine(message));}
